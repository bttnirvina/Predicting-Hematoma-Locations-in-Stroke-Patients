...
def FCN8(input_height=512,input_width=512, image_depth=3):
    ...
    assert input_height%64 == 0
    assert input_width%64 == 0
    ...
    # Layer 6 input=(16x16x512), output=(8x8x512)
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='block6_conv1', data_format="channels_last")(pool5)
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='block6_conv2', data_format="channels_last")(x)
    x = Conv2D(512, (3, 3), activation='relu', padding='same', name='block6_conv3', data_format="channels_last")(x)
    pool6 = MaxPooling2D((2, 2), strides=(2, 2), name='block6_pool', data_format="channels_last")(x)## (None, 7, 7, 512)
    # Layer 6 input=(32x32x512), output=(16x16x512) ***
    #x = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv1', data_format="channels_last")(pool4)
    #x = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv2', data_format="channels_last")(x)
    #x = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv3', data_format="channels_last")(x)
    #pool5 = MaxPooling2D((2, 2), strides=(2, 2), name='block5_pool', data_format="channels_last")(x)## (None, 7, 7, 512)

    # input=(8x8x512), output=(8x8x4096)
    o = (Conv2D(4096,(7 ,7), activation='relu', padding='same', name="conv6", data_format="channels_last"))(pool6)
    ...
    conv7_4 = Conv2DTranspose(nClasses, kernel_size=(32,32), strides=(32,32), use_bias=False, data_format="channels_last")(conv7)
    ## (None, 224, 224, 10)
    ## 2 times upsampling for pool411
    pool411 = (Conv2D(nClasses, (1,1), activation='relu', padding='same', name="pool4_11", data_format="channels_last"))(pool4)
    pool411_2 = (Conv2DTranspose(nClasses , kernel_size=(8,8), strides=(8,8), use_bias=False, data_format="channels_last"))(pool411)

    pool311 = (Conv2D(nClasses, (1,1), activation='relu', padding='same', name="pool3_11", data_format="channels_last"))(pool3)
    pool311_2 = (Conv2DTranspose(nClasses , kernel_size=(4,4), strides=(4,4), use_bias=False, data_format="channels_last"))(pool311)

    pool511 = (Conv2D(nClasses, (1,1), activation='relu', padding='same', name="pool5_11", data_format="channels_last"))(pool5)
    pool511_2 = (Conv2DTranspose(nClasses , kernel_size=(16,16), strides=(16,16), use_bias=False, data_format="channels_last"))(pool511)

    o = Add(name="add")([pool411_2, pool311_2, pool511_2, conv7_4])
    o = Conv2DTranspose(nClasses, kernel_size=(2,2),  strides=(2,2), use_bias=False, data_format="channels_last")(o)
